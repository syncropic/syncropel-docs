...
The on-disk location depends on which agent CLI ran. For **Claude Code**, sessions are typically under `~/.claude/projects/<slug>/<session_id>.jsonl`. Try the slug first:

```bash
SLUG=-home-you-projects-myproject
SID=a3f29c4e-0b1d-4f8a-9e21-5b7c8d1e4f2a

ls ~/.claude/projects/$SLUG/$SID.jsonl
```
