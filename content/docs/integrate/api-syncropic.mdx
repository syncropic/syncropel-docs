...
|---|---|---|
| **Per-instance bearer** | Hosted instance provisioning | Your hosted instance uses this automatically |
| **User-issued API key** | `syncropel.com/account/api-keys` | Your scripts and apps; revocable per-key |
| **Self-host bearer** | Your own `spl serve` | Self-host customers running their own instance |
