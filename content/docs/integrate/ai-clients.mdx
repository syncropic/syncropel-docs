...
| **Programmatic** | Any agent that writes code (code-execution-capable LLMs, Workers agents, custom harnesses) | `@syncropel/sdk` (npm) or `syncropel` (PyPI) | A bearer token at `Client` construction |
