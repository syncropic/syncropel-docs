...
[Anthropic](https://www.anthropic.com/engineering/code-execution-with-mcp) makes the case: LLMs are trained on far more code than tool-call protocols. Presenting tools as a typed SDK in a sandboxed code environment yields large token savings for multi-step workflows. Chain 20 emits into one context round-trip instead of 20.
