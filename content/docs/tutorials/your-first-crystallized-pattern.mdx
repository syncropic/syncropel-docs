...
- Completed [Your first decision gate](./your-first-aitl-approval) — patterns build on top of approved rules.
...
If no rules exist yet for this shape, Syncropel will treat the new INTEND like the unrouted record from [the decision-gate tutorial](./your-first-aitl-approval) — proposing a routing rule as a decision request for you to approve. The pattern is observable but no auto-routing happens until a rule covers the shape.
