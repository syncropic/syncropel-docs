...
<Callout type="info">
This tutorial assumes you already have **`spl` installed and a daemon running** with a token in `~/.syncro/token`. If you don't, do the [Quick Start](/docs/tutorials/quickstart) and [Authentication setup](/docs/operate/keyring) first — both take under five minutes.
</Callout>
