...
<Callout type="info">
This tutorial assumes you already have **`spl` installed and a instance running** with a token in `~/.syncro/token`. If you don't, do the [Quickstart](/docs/start) and [Authentication setup](/docs/operate/keyring) first — both take under five minutes.
</Callout>
