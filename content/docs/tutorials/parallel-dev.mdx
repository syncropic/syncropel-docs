...
This sends SIGTERM to both worker daemons. Each emits a final heartbeat with `health: "draining"` before exiting. The coordinator stays running for overnight scheduled work (the common case at end-of-day).
