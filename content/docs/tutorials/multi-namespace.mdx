...
You'll need: a running `spl serve --daemon` (the [Quickstart](/docs/start) covers this), and `curl`. About 15 minutes.
...
- **[Spec §08-governance/04](https://github.com/syncropic/syncropel-spec/blob/main/08-governance/04-namespaces.md)** — normative source
