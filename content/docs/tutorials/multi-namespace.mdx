...
The error tells you exactly what's wrong AND how to fix it. This is the [monotonic narrowing rule](/docs/concepts/namespaces#the-narrowing-rule) in action — the instance walked the ancestor chain, hit `fake-corp`, found it missing from the registry, and refused the write.
