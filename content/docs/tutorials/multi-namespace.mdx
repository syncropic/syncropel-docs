...
You'll need: a running `spl start` (the [Quickstart](/docs/start) covers this), and `curl`. About 15 minutes.
...
You should see 7 PASS checks. If `daemon reachable` fails, run `spl start` first.
