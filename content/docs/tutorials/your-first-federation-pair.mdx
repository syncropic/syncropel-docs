...
- [ADR-063 federation pair primitive](https://github.com/syncropic/syncropel-spec/blob/main/15-decisions/ADR-063-federation-pair-primitive.md) — the canonical specification.
