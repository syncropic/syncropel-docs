...
The output shows a thread ID and an alias (like `SKL-0001`) that you can use as a shorthand.
...
SKL-0001     inbox    high   Add input validation to the signup...   —
```
...
```bash
spl task done SKL-0001 --summary "Added email format and password length validation" --domain code
```
...
```bash
spl task approve SKL-0001 --domain code --notes "Validation logic verified, tests pass"
```
