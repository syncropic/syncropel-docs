...
<Callout type="info">
Requires **a version of `spl` with fleet support**. If you want the full hands-on walkthrough with real work and mid-run failures, go to [Parallel Dev — Monday Morning Walkthrough](/docs/tutorials/parallel-dev). If you just want to see what a fan-out *looks like*, you're in the right place.
</Callout>
