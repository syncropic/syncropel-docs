...
If you ever want to re-spawn local from scratch and re-import the bundle, the migration runs in reverse without ceremony — `spl start` to boot fresh, `spl import ~/migration.tar.zst` to populate, done. Steward equivalence cuts both directions.
