---
title: Secrets
description: Records hold handles. Backends hold values. The substrate enforces the separation at four independent layers — a deliberate "no plaintext secrets in records, ever" invariant baked into the protocol.
---
...
- [Records](./records) — the substrate primitive that holds credential handles + audit metadata
