...
This is a structural invariant, not a convention. **Frozen Foundation F16** says a record body, at any hash level, must not contain a plaintext secret value. Syncropel enforces F16 at four independent layers — a bypass of any one layer leaves the remaining three load-bearing.
