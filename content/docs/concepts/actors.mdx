...
Trust starts at zero. With few observations, the score stays conservative. With many observations, it converges to the empirical success rate. See [Trust](/docs/concepts/trust) for the full model: how recent results outweigh old ones, why self-evaluation is structurally ignored, and how the score shapes what a member may do on its own.
