...
| **`static-render`** | documents, reports, decks — presented, not executed | Named; on the roadmap |
| **`iframe-embed`** | sandboxed embedded surfaces | Named; on the roadmap |
| **`wasm-app`** | live apps, games, world-models — executable media | Named; gated on the sandbox work |
