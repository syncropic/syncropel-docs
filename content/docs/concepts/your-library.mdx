...
**Finding things today:** you can browse everything, filter by type and recency, and search by name. Searching *inside* your content — full-text and "find things like this" — is on the way; until it lands, name your things the way you'd look for them.
