...
L0 never leaves its namespace of origin without explicit consent — this is [F8](/docs/reference/glossary), the namespace isolation invariant. L1 through L3 are structural and safe to share across namespaces, which is what makes cross-namespace pattern replay viable without leaking content.
