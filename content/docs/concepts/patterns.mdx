...
- **Replay shortcut fully wired across all decision points.** Routing short-circuits on L1 match today; the decision gate and fold-rule contexts don't yet. Wiring is straightforward but per-context.
