...
<Mermaid
  caption="spl daemon crate dependency graph. Strict layering, no upward dependencies."
  chart={`flowchart TD
    algebra["syncropel-algebra"]
    trust["syncropel-trust"]
    store["syncropel-store"]
    ai["syncropel-ai"]
    expr["syncropel-expr"]
    engine["syncropel-engine"]
    protocol["syncropel-protocol"]
    spl["spl"]
...
<Mermaid
  ...
  chart={`sequenceDiagram
    ...
    K->>K: spl serve --daemon<br/>read SPL_BOOTSTRAP_TOKEN
