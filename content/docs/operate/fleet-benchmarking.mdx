...
- [Bootstrap Measurement Methodology](https://github.com/syncropic/syncropel-research/blob/main/docs/compute-plane/09-v0.11-bootstrap-measurement-methodology.md) — the full research document this guide distills
