...
<Callout type="info">
**Audience**: operators who want to verify v0.11.0's parallel velocity claim against their own workloads. This page is the actionable companion to the bootstrap measurement methodology .
</Callout>
...
**Recommended threshold** (same as v0.11.0 — the standard threshold):
