...
If the instance has the sandboxed work-loop transport on, the rollback is one config record (`transport: in_process`); see [The sandboxed transport](./sandboxed-transport).
