...
`spl serve` detaches from your terminal and runs in the
...
user session; a LaunchInstance runs system-wide. For a personal
...
This usually means the supervisor is running `spl serve`
...
- [Starting Your Instance](/docs/get-started/instance) — the three modes
