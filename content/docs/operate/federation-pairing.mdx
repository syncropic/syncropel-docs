...
The diagram above is the canonical handshake; the full sequence is specified in [ADR-063](https://github.com/syncropic/syncropel-spec/blob/main/15-decisions/ADR-063-federation-pair-primitive.md).
