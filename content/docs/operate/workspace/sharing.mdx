...
[`spl workspace publish --release`](/docs/operate/workspace/lifecycle#published).
...
- [Tutorial: Build your first workspace](/docs/tutorials/first-workspace) — the happy path that uses `--draft` and `--release`, not `spl share`
- [Workspace lifecycle](/docs/operate/workspace/lifecycle) — when to publish vs. when to share
- [Testing workspaces](/docs/operate/workspace/testing) — exercising your workspace with fixtures
