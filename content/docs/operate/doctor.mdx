---
title: spl doctor
description: Top-down diagnostic that audits a instance's filesystem state, PID files, ports, config, and permissions. Run this first when something feels wrong.
---
...
⚠ PID file references pid 12847, but no such process is alive.
  Recovery:
    pgrep -af "spl serve"
    kill <pid>      # if a instance is running
