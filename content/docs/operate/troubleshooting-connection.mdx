...
**Fix**: Upgrade the daemon: `curl -sSf https://get.syncropic.com/spl | sh && spl stop && spl serve`. Or grant PNA permission
...
| `CORS` | Origin not on daemon's CORS allowlist | `spl config auth-set-cors-origins https://syncropel.com http://localhost:3000 && spl stop && spl serve` |
