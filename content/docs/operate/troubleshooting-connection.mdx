...
description: The 10 connection-state failure modes the syncropel.com /local workspace can hit, with remediation per state and a common-error-code reference.
---
...
visit [`/local/diagnose`](https://syncropel.com/local/diagnose). The
page shows:
