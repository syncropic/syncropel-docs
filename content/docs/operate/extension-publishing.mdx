...
- **Permission policy** — [CEL expressions guide](/docs/guides/cel-expressions) covers what record writes the kernel will accept regardless of what an extension asks for.
