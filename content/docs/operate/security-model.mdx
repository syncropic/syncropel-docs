...
- **What's coming**: OS-keyring integration (macOS Keychain, Linux Secret Service, Windows Credential Manager) is on the roadmap. Until it ships, file-permission discipline is the only at-rest defense.
