...
If you're trying to *find* peer daemons you don't yet have URLs for, start with the [federation discovery guide](./federation-discovery) instead. If you want records to reach a peer that's offline, see the [async federation guide](./async-federation).
