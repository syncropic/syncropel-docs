...
Sync pair state is held in memory. After a daemon restart, pairs need to be recreated — `spl fleet sync add ...` again. Script your pair setup into your daemon startup procedure if you rely on long-running pairs.
