...
**When to use:** classification, structured extraction, tagging. Anything where responses are naturally comparable as JSON trees and you want the system's collective best-guess.
