...
The dial is Syncropel's novelty knob from [Frozen Foundation F3](/docs/concepts/trust#the-dial) — d in [0, 1], with thresholds at 1/3 (REPLAY), 1/2 (ADAPT), 2/3 (EXPLORE). In an inference query it influences relevance weighting (higher d = more willingness to try novel responders).
