...
A *steward* is any running Syncropel instance — your laptop daemon, a hosted instance at `<label>.syncropel.com`, or a self-hosted server you run for a project. Two stewards can be **paired** so they sync records consent-gated.
...
> **Authoritative reference**: [ADR-069](https://github.com/syncropic/syncropel-spec/blob/main/15-decisions/ADR-069-aitl-kind-dispatcher-and-pair-completion.md) covers the AITL kind dispatcher pattern and the operator-approval completion contract end-to-end.
