...
Any CLI-based agent that reads a prompt and produces output can integrate. Commonly used:
...
```bash
spl task done SKL-0001 --summary "Fixed token validation logic" --domain code
```
