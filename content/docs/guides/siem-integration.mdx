...
The audit export pipeline is the v0.10.0 first slice. Two follow-ups are tracked:
...
Neither is blocking for v0.10.0 — the current CLI-driven pipeline is fully functional. They're efficiency + completeness improvements for the next iteration.
