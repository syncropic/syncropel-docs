...
description: Browse, upload, organize, and publish files on a Syncropel workspace with the spl fs command.
---
...
You need a running workspace — see [Your first run](/docs/get-started/first-run)
to set one up locally, or [Hosted workspaces](/docs/get-started/hosted) for a
managed one. `spl fs` talks to whichever workspace your CLI is pointed at, and
...
`spl fs mounts` lists external drives connected to the workspace. Connected
...
Everything here is also available visually. Open your workspace on the web
...
instance](/docs/guides/files-in-studio) for the full walkthrough — drag-
...
- [Working with files in your workspace](/docs/guides/files-in-studio) — the
  same filesystem, visually.
