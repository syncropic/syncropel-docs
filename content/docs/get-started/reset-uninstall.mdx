...
After `spl init` you're back at the start of the onboarding flow — start the daemon in dev mode, bootstrap a service account, save the token, flip to secure mode. See [Service accounts](/docs/get-started/service-accounts).
...
See [Windows Service](/docs/operate/windows-service) for details.
