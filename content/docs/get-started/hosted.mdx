...
description: Skip the install — sign in at syncropel.com and have a fully-portable Syncropel instance running in about a minute. Self-hosted and hosted are first-class equals; this page walks through the hosted onboarding path end-to-end.
---
...
Hosted instances are **$25 per month per instance** with a **30-day free trial**; see [Pricing](/docs/get-started/pricing).
...
Want another instance for a separate project? Provision again; each instance is billed on its own.
...
| Cost | $25 per month per instance after a 30-day trial | Whatever your machine costs |
