...
<Callout type="warn">
**This snippet is security-sensitive.** It accepts messages from a sandboxed iframe and forwards record emits to a Syncropel daemon. Read the [Security expectations](#security-expectations) section before deploying. A bad origin check or weak capability gate gives an extension full kernel access.
</Callout>
