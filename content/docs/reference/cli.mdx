...
| `--verify` | Run under independent evaluation (ADR-112): planner expands the goal into acceptance criteria, a separate evaluator judges the result, the loop never self-asserts "done". Forced on for Trial-tier actors. |
