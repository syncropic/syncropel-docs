...
spl start            # alias for `spl serve --daemon`
spl stop             # alias for `spl serve --stop`
spl restart          # alias for `spl serve --restart`
