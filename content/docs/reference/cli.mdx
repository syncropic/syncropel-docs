...
The `spl federation` verb is the canonical surface for federation pair management (ADR-063). One command establishes a pair; subsequent verbs manage its lifecycle. See the [federation pair guide](/docs/guides/federation-pair) for a walkthrough.
...
# Cross-namespace consent grants (composes with ADR-024)
