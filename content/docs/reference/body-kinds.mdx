...
For the kind grammar itself (3 vs 4 segments, allowed characters, reserved scopes, version semantics), see [ADR-034](https://github.com/syncropic/syncropel-spec/blob/main/15-decisions/ADR-034-body-kind-grammar.md).
...
- **`core.runtime.v1`** — pluggable runtime descriptor for extensions (ADR-050). See [Extensions](/docs/guides/extensions).
...
- **[ADR-034: body.kind grammar](https://github.com/syncropic/syncropel-spec/blob/main/15-decisions/ADR-034-body-kind-grammar.md)** — the grammar all kinds (built-in or extension) follow.
