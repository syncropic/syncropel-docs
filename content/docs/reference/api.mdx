...
The substrate for adding either a new device of yours (guest holder) or a federated colleague (federated holder). Operator-facing guide: [Pair, share, invite](../guides/pair-share-invite). SDK surface: `client.invites.*` in the [TypeScript SDK guide](../guides/typescript-sdk#invites).
